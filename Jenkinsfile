pipeline {
    ...
    parameters {
        string(name: 'GIT_REPO', description: 'Git Repository URL', defaultValue: 'https://github.com/karthikkumawat3214/tourist-website.git')
    ...
    stages {
        ...
        stage('Deploy to Apache') {
            steps {
                script {
                    def sourceDir = "C:\\Users\\HP\\Desktop\\tourist-website-main\\tourist-website-main"
